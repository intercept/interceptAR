...
public:
    ...
    // Intercept::FunctionType

    std::string_view (*Type_Function_GetName)(const void* functionType);
    void* (*Type_Function_GetModule)(const void* functionType);

    // Intercept::ClassType

    std::string_view (*Type_Class_GetName)(const void* classType);
    void* (*Type_Class_GetModule)(const void* classType);
    void* (*Type_Class_GetBaseClass)(const void* classType);
    std::span<void*> (*Type_Class_GetVariables)(const void* classType);
    std::span<void*> (*Type_Class_GetFunctions)(const void* classType);

    // Intercept::ScriptModule

    std::string_view (*Type_ScriptModule_GetName)(const void* scriptModule);
    void* (*Type_ScriptModule_FindType)(const void* scriptModule, std::string_view typeName);
    std::span<void*> (*Type_ScriptModule_GetVariables)(const void* scriptModule);
    std::span<void*> (*Type_ScriptModule_GetFunctions)(const void* scriptModule);
    std::span<void*> (*Type_ScriptModule_GetTypes)(const void* scriptModule);
...
export namespace Intercept {
    ...
    void Print(LogLevel level, std::string_view msg)
    {
